package com.example.biostarh61.locationapp;
...
public class MapActivity_A extends AppCompatActivity
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(MapActivity_A.this, PETICION_CONFIG_UBICACION);
    ...
    private void startLocationUpdates() {
        if (ActivityCompat.checkSelfPermission(MapActivity_A.this,
            ...
            LocationServices.FusedLocationApi.requestLocationUpdates(
                    apiClient, locRequest, MapActivity_A.this);
        }
    }
